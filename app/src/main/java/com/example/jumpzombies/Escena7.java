...
public class Escena7 extends Escena {
    ...
    public Escena7(Context context, int anchoPantalla, int altoPantalla, int numEscena) {
    ...
    public void dibuja(Canvas c) {
        ...
        super.dibuja(c);
        fondo.dibuja(c);
        c.drawText("Fin del Juego",(int)(anchoPantalla/1.7), altoPantalla/3,p2);
