...
public class Botones {
    /**
     * posicionX indica las coordenadas del eje x donde se situara el botón
     */
    public int posicionX;
    /**
     * posicionY indica las coordenadas del eje y donde se situara el botón
     */
    public int posicionY;
    /**
     * imagen es el bitmap del boton que vamos a dibujar
     */
    public Bitmap imagen;

    /**
     * Constructor donde se inicializan los atributos
     * @param imagen bitmap del botón
     * @param posicionX coordenadas del eje x
     * @param posicionY coordenadas del eje y
     */
    public Botones(Bitmap imagen,int posicionX,int posicionY) {
    ...
    /**
     * Método que dibuja el boton correspondiente en el lienzo
     * @param c el lienzo
     */
    ...
    /**
     * Setter que pasando un Bitmap modifica el bitmap de imagen
